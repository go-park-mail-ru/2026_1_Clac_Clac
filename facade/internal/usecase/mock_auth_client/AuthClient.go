...
func (_m *AuthClient) CreateSession(ctx context.Context, userLink uuid.UUID) (string, error) {
...
func (_m *AuthClient) DeleteSession(ctx context.Context, sessionID string) error {
...
func (_m *AuthClient) ExchangeVKCode(ctx context.Context, code string) (string, string, error) {

...
// ListSectionLink содержит упорядоченный список UUID секций.
//
...
// SectionInfo содержит информацию о секции доски.
//
...
// CreateSectionRequest содержит данные для создания секции.
//
...
// SectionsResponse содержит список секций доски.
//
//	@Description	Список секций доски
...
// CardsResponse содержит список карточек секции.
//

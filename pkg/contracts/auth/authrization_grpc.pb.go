...
const (
	...
	AuthService_CheckCSRFToken_FullMethodName    = "/auth.AuthService/CheckCSRFToken"
)
...
type AuthServiceClient interface {
	...
	GenerateCSRFToken(ctx context.Context, in *CSRFTokenRequest, opts ...grpc.CallOption) (*CSRFTokenResponse, error)
	CheckCSRFToken(ctx context.Context, in *CSRFCheckRequest, opts ...grpc.CallOption) (*CSRFCheckResponse, error)
}
...
func (c *authServiceClient) GenerateCSRFToken(ctx context.Context, in *CSRFTokenRequest, opts ...grpc.CallOption) (*CSRFTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authServiceClient) CheckCSRFToken(ctx context.Context, in *CSRFCheckRequest, opts ...grpc.CallOption) (*CSRFCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CSRFCheckResponse)
	err := c.cc.Invoke(ctx, AuthService_CheckCSRFToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	GenerateCSRFToken(context.Context, *CSRFTokenRequest) (*CSRFTokenResponse, error)
	CheckCSRFToken(context.Context, *CSRFCheckRequest) (*CSRFCheckResponse, error)
...
func (UnimplementedAuthServiceServer) GenerateCSRFToken(context.Context, *CSRFTokenRequest) (*CSRFTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateCSRFToken not implemented")
}
func (UnimplementedAuthServiceServer) CheckCSRFToken(context.Context, *CSRFCheckRequest) (*CSRFCheckResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckCSRFToken not implemented")
}
...
func _AuthService_GenerateCSRFToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GenerateCSRFToken(ctx, req.(*CSRFTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_CheckCSRFToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CSRFCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).CheckCSRFToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_CheckCSRFToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CheckCSRFToken(ctx, req.(*CSRFCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_CheckCSRFToken_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "contracts/authrization/authrization.proto",
}

...
const (
	...
	CardService_UpdateCardPoints_FullMethodName   = "/proto.card.v1.CardService/UpdateCardPoints"
)
...
type CardServiceClient interface {
	...
	UpdateCardPoints(ctx context.Context, in *UpdateCardPointsRequest, opts ...grpc.CallOption) (*UpdateCardPointsResponse, error)
}
...
func (c *cardServiceClient) UpdateCardPoints(ctx context.Context, in *UpdateCardPointsRequest, opts ...grpc.CallOption) (*UpdateCardPointsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateCardPointsResponse)
	err := c.cc.Invoke(ctx, CardService_UpdateCardPoints_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CardServiceServer interface {
	...
	UpdateCardPoints(context.Context, *UpdateCardPointsRequest) (*UpdateCardPointsResponse, error)
...
func (UnimplementedCardServiceServer) UpdateCardPoints(context.Context, *UpdateCardPointsRequest) (*UpdateCardPointsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateCardPoints not implemented")
}
...
func _CardService_UpdateCardPoints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateCardPointsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CardServiceServer).UpdateCardPoints(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CardService_UpdateCardPoints_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CardServiceServer).UpdateCardPoints(ctx, req.(*UpdateCardPointsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

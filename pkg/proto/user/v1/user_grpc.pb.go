...
const (
	...
	UserService_GetProfiles_FullMethodName       = "/proto.user.v1.UserService/GetProfiles"
...
type UserServiceClient interface {
	...
	UpdateAvatar(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UpdateAvatarRequest, AvatarResponse], error)
...
func (c *userServiceClient) UpdateAvatar(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UpdateAvatarRequest, AvatarResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], UserService_UpdateAvatar_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[UpdateAvatarRequest, AvatarResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_UpdateAvatarClient = grpc.ClientStreamingClient[UpdateAvatarRequest, AvatarResponse]
...
type UserServiceServer interface {
	...
	UpdateAvatar(grpc.ClientStreamingServer[UpdateAvatarRequest, AvatarResponse]) error
...
func (UnimplementedUserServiceServer) UpdateAvatar(grpc.ClientStreamingServer[UpdateAvatarRequest, AvatarResponse]) error {
	return status.Error(codes.Unimplemented, "method UpdateAvatar not implemented")
}
...
func _UserService_UpdateAvatar_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).UpdateAvatar(&grpc.GenericServerStream[UpdateAvatarRequest, AvatarResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_UpdateAvatarServer = grpc.ClientStreamingServer[UpdateAvatarRequest, AvatarResponse]

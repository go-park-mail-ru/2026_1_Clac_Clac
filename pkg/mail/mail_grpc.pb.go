...
type MailServiceClient interface {
	SendEmail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*SendMmailResponse, error)
}
...
func (c *mailServiceClient) SendEmail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*SendMmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendMmailResponse)
...
type MailServiceServer interface {
	SendEmail(context.Context, *SendMailRequest) (*SendMmailResponse, error)
...
func (UnimplementedMailServiceServer) SendEmail(context.Context, *SendMailRequest) (*SendMmailResponse, error) {
...
func _MailService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).SendEmail(ctx, req.(*SendMailRequest))
	}
...
var MailService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "contracts/mail/mail.proto",
}

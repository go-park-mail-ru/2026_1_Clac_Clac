...
// CheckCode provides a mock function with given fields: ctx, tokenID
func (_m *AuthService) CheckCode(ctx context.Context, tokenID string) error {
...
// DiliveryCodeReseting provides a mock function with given fields: ctx, email
func (_m *AuthService) DiliveryCodeReseting(ctx context.Context, email string) error {
	ret := _m.Called(ctx, email)

	if len(ret) == 0 {
		panic("no return value specified for DiliveryCodeReseting")
	}

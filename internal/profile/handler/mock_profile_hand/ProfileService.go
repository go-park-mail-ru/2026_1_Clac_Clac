...
package mockProfileHand

import (
	context "context"

	models "github.com/go-park-mail-ru/2026_1_Clac_Clac/internal/profile/models"
...
func (_m *ProfileService) GetProfileUser(ctx context.Context, userID uuid.UUID) (models.User, error) {

...
func (_m *AuthService) EnsureUserByEmail(ctx context.Context, info dto.UserInfo) (models.User, error) {
	...
	var r0 models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dto.UserInfo) (models.User, error)); ok {
		return rf(ctx, info)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dto.UserInfo) models.User); ok {
		r0 = rf(ctx, info)
	} else {
		r0 = ret.Get(0).(models.User)
	}

	if rf, ok := ret.Get(1).(func(context.Context, dto.UserInfo) error); ok {
		r1 = rf(ctx, info)
	} else {
		r1 = ret.Error(1)
	}
